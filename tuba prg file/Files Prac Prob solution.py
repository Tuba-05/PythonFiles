...
##def crypto(x):
##    f = open(x,'r+')
##    g = f.read().replace('secret','xxxxxx')
##    k = f.seek(0)
##    h = f.write(g)
##    f.close()
##
...
##    g = f.read()
##    a = g.split()
##    w = input('Name of the file to be created with extension :')
##    p = open(w,'w')
##    for i in a:
##        if  len(i) >= 4:
##             d = i[:5]
...
##            e = i + ' '
##        p.write(e)
##n = input('Enter name of created file with extension : ')
##censor(n)
                                                              # QUESTION NO. 3


##def fcopy():
##    a = input('Enter name of original file with extension : ')
##    b = input('Enter name of file to be created with extension : ')
##    e = open(b,'w')
##    c = open(a)
##    k = c.read()
##    d = k.split('.')
...
##        elif i == 'B-':
##            count5 += 1
##    print(count1,' students got A+')
##    print(count2,' students got A')
##    print(count3,' students got B+')
##    print(count4,' students got B')
##    print(count5,' students got B-')
##distribution()
...
def game():
    ...
    word = Secret_word()
    secret_word = '' * len(word)  #the letters of the word are replaced by ''
    time.sleep(1)
    ...
    if secret_word == word:
        ...
        user_score(secret_word, guess, user_name) #calls the userscore function
    else:
